...
function Ranking({commented}) {
    ...
    useEffect(() => {
        let boradId  =commented.map((item) => item.board_id);
    ...
    return!isMobile ? (
        ...
        (
            <>
                <RankingWrap>
                    <PopularTitle> <div><img src={`${process.env.PUBLIC_URL}/image/ranking.png`} alt=""/></div>레시피 Total 조회 순위</PopularTitle>
                    <BannerWrap>
                        <Swiper
                            loop={false}
                            allowTouchMove={true}
                        ...
                        >
                            ...
                            <SwiperSlide >
                                <MobileMore>
                                    <div><Link to="rangking"> <img src={`${process.env.PUBLIC_URL}/image/mobile-more.png`} alt=""/></Link></div>
                                    <div>더 보기</div>
                                </MobileMore>
                            </SwiperSlide>
                        </Swiper>
