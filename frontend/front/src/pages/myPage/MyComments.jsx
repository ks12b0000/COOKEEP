...
const MyComments = () => {
  ...
  const getCommentList = async () => {
    try {
      const res = await authHttp.getCommentList(
        userId,
        SelectedButton,
      );
      console.log(res);
                  ...
                  <>
                    <ContentsWrap>
                      {Comments.map((comment) => (
                        <ContentsBox onClick={() => { window.open(`https://www.teamprojectvv.shop/category/${comment.board_id}`, '_self') }} key={comment.board_id}>
                          <ContentsText>{comment.title}</ContentsText>
